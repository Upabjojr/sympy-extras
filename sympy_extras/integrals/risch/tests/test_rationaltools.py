...
from sympy_extras.integrals.risch.rationaltools import (ratint, ratint_logpart,
...
def test_ratint_radical_coefficients() -> None:
    # issue 26502
...
def test_log_to_real_complex_only() -> None:
...
def test_issue_28186() -> None:
    ...
    # the top-level integrate is SymPy's; the ported ratint is what the
    # pull request fixed
    assert ratint(f, w) == F

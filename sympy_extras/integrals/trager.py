...
from sympy_extras._typing import ExprLike, as_expr, free_symbols, sorted_symbols
...
def _index_n(f: Expr, x: Symbol) -> Optional[tuple[Expr, Expr]]:
    ...
    k*P'/(n*P)*R = A_k``; ``h`` collects the components without one
    (whose integrals may still be elementary, with logarithms of
    algebraic functions: undecided)."""

...
The projection phase is in :mod:`sympy_extras.polys.cad.projection`, the
exact real algebraic sample points in
:mod:`sympy_extras.polys.cad.samplepoints` and the lifting phase, with the
main entry point :func:`cylindrical_algebraic_decomposition`, in
:mod:`sympy_extras.polys.cad.lifting`. Quantifier elimination and decision
of formulas built on top of it are in :mod:`sympy_extras.polys.cad.qe`.
"""
...
from .qe import (quantifier_elimination, decide, sample_points, solution_set,
    truth_tables)
from .cylindrical import IndexedRoot, cylindrical_cases, cylindrical_formula, cylindrical_set
